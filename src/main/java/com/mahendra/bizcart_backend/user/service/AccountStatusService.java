...
public class AccountStatusService {
	...
	public AccountStatusService(UserRepository userRepository, RefreshTokenRepository refreshTokenRepository, Clock clock) {
	...
	public AccountStatusResponseDto updateStatus(Long adminUserId, Long targetUserId,
		...
		if (newStatus == AccountStatus.BLOCKED || newStatus == AccountStatus.INACTIVE) {
			...
			refreshTokenRepository.revokeActiveTokensByUserId(targetUserId, now,
